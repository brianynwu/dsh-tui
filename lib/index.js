...
const wordSegmenter$3 = new Intl.Segmenter(void 0, { granularity: "word" });
/**
...
function findWordBackward$1(text, cursor, options) {
	...
	const segments = segmentFn ? [...segmentFn(textBeforeCursor)] : [...wordSegmenter$2.segment(textBeforeCursor)];
...
function findWordForward$1(text, cursor, options) {
	...
	const segmentFn = options?.segment;
	const isAtomic = options?.isAtomicSegment;
	const iterator = (segmentFn ? segmentFn(textAfterCursor) : wordSegmenter$2.segment(textAfterCursor))[Symbol.iterator]();
